...
public class HighScores : MonoBehaviour {
	...
	//high score script to read and write the top 10 scores to the notepad file
	//scores are only in points from killing or collecting, not time, highest points wins
